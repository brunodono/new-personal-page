        ...
        <>
            ...
            <div className={styles.content}>
                <div className={styles.column}>
                    ...
                    I love software development, maintaining and building web pages. I'm seeking for new opportunities and challenges that allow me to expand my skill set ! Want to hire, talk or just discuss regarding any project ? I'm always available to listen to you, please contact me. <span>smile</span>
                    </p>
